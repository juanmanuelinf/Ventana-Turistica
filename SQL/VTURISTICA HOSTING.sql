...
ALTER TABLE [Publicacion] ADD CONSTRAINT [PK_EmpresaPublicacion] FOREIGN KEY ([IdEmpresa]) REFERENCES [Empresa] ([IdEmpresa])  ON  DELETE CASCADE
go

ALTER TABLE [Publicacion] ADD CONSTRAINT [PK_SubCategoriaPublicacion] FOREIGN KEY ([IdSubCategoria]) REFERENCES [SubCategoria] ([IdSubCategoria])  ON  DELETE CASCADE
go

ALTER TABLE [SubCategoria] ADD CONSTRAINT [FK_IdCategoria] FOREIGN KEY ([IdCategoria]) REFERENCES [Categoria] ([IdCategoria])  ON  DELETE CASCADE
go

ALTER TABLE [Precio] ADD CONSTRAINT [FK_PublicacionPrecio] FOREIGN KEY ([IdPublicacion]) REFERENCES [Publicacion] ([IdPublicacion])  ON  DELETE CASCADE
go

ALTER TABLE [Imagenes] ADD CONSTRAINT [FK_PublicacionImagenes] FOREIGN KEY ([IdPublicacion]) REFERENCES [Publicacion] ([IdPublicacion])  ON  DELETE CASCADE
go

ALTER TABLE [Imagenes] ADD CONSTRAINT [FK_ImagenesPatrocinante] FOREIGN KEY ([IdPatrocinante]) REFERENCES [Patrocinante] ([IdPatrocinante])  ON DELETE CASCADE
go

ALTER TABLE [PublicacionServicio] ADD CONSTRAINT [FK_PublicacionServicio] FOREIGN KEY ([IdPublicacion]) REFERENCES [Publicacion] ([IdPublicacion])  ON  DELETE CASCADE
go

ALTER TABLE [PublicacionServicio] ADD CONSTRAINT [FK_PublicacionServicio2] FOREIGN KEY ([IdServicio]) REFERENCES [Servicio] ([IdServicio])  ON  DELETE CASCADE
go

ALTER TABLE [Telefono] ADD CONSTRAINT [FK_EmpresaTelefono] FOREIGN KEY ([IdEmpresa]) REFERENCES [Empresa] ([IdEmpresa])   ON  DELETE CASCADE
go

ALTER TABLE [Contacto] ADD CONSTRAINT [FK_EmpresaContacto] FOREIGN KEY ([IdEmpresa]) REFERENCES [Empresa] ([IdEmpresa])  ON  DELETE CASCADE
go

ALTER TABLE [Telefono] ADD CONSTRAINT [FK_ContactoTelefono] FOREIGN KEY ([IdContacto]) REFERENCES [Contacto] ([IdContacto]) 
GO

ALTER TABLE [Contacto] ADD CONSTRAINT [FK_PatrocinanteContacto] FOREIGN KEY ([IdPatrocinante]) REFERENCES [Patrocinante] ([IdPatrocinante])  ON  DELETE CASCADE
go

ALTER TABLE [Idioma] ADD CONSTRAINT [FKIdiomaPublicacion] FOREIGN KEY ([IdPublicacion]) REFERENCES [Publicacion] ([IdPublicacion])  ON  DELETE CASCADE
go
